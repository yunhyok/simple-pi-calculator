...
저장소: https://github.com/yunhyok/simple-pi-calculator (public, MIT). 로컬 커밋 4개, push 대기(세션 git 프록시 403 → 사용자가 저장소를 세션 소스에 추가하거나 bundle로 직접 push).
...
- 미검증: 실제 Windows 빌드/Inno Setup(CI에서 확인 예정).
